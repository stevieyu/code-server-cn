FROM docker.1ms.run/library/nim
...
RUN git config --global url."https://gh-proxy.stvcf.ggff.net/github.com/".insteadOf "https://github.com/"
...
# wslc build -t nim:ssh -f nim.Dockerfile .
# wslc run --rm -it -p 8022:22 -p 8080:8080 -v ${HOME}/.ssh:/root/.ssh nim:ssh
